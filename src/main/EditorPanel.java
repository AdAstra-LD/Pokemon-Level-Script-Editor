...
//    private DoubleProperty opacity = new SimpleDoubleProperty();
    ...
    private void aboutMenuItemActionPerformed(ActionEvent e) {
        JOptionPane.showMessageDialog(this, defaultTitle + " by AdAstra/LD3005. [2023]\n\np.s. turtleisaac was here", "About...", JOptionPane.INFORMATION_MESSAGE, new ImageIcon(EditorPanel.class.getResource("/resources/logo.png")));
    }
    ...
    private void initComponents() throws InvalidFieldsException, DuplicateTriggerException {
        ...
        setName("Pok\u00e9mon Level Script Editor 2.0");
        ...
        //======== menuBar1 ========
        {
            ...
            //======== fileMenu ========
            {
                ...
                fileMenu.setForeground(new Color(60, 63, 65));
